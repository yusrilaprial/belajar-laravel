...
Route::put('/class-update/{id}', [ClassController::class, 'update'])->middleware(['auth', 'must-admin']);
...
Route::put('/extracurricular-update/{id}', [ExtracurricularController::class, 'update'])->middleware(['auth', 'must-admin']);
...
Route::put('/teacher-update/{id}', [TeacherController::class, 'update'])->middleware(['auth', 'must-admin']);
